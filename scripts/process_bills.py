...
def process_all_bills() -> None:
    """Process all PDF budget bill files."""
    ...
    logger.info(f"Found {len(pdf_files)} bill files to process")
    ...
    logger.info(f"\nProcessed {processed_count}/{len(pdf_files)} bill files successfully")
